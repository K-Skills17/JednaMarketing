        ...
        <div className="container-site">
          <div className="max-w-xl mx-auto text-center">
            ...
            <div className="text-left bg-white border border-ink/10 rounded-sm p-8 mb-10">
              <h2 className="font-semibold text-ink text-base mb-6">Prepare your database export (optional but useful)</h2>
              <ol className="space-y-5">
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium text-ink text-sm">Log into your practice management software</p>
                    <p className="text-muted text-sm mt-0.5">Dentrix, Eaglesoft, Open Dental, or any PMS. We can also work from a CRM export or ad account list.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium text-ink text-sm">Run your unscheduled treatment report + lapsed recall list</p>
                    <p className="text-muted text-sm mt-0.5">Export: name, phone, email, date of last contact. That&apos;s all we need to count the recoverable patients live.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm mt-0.5">We&apos;ll screen-share and count the contactable patients live. You&apos;ll leave the call knowing your exact recoverable-revenue number.</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="bg-ink/5 border border-ink/10 rounded-sm p-8 mb-10 text-center">
              ...
              <p className="text-muted-light text-xs">A short demo of the Revive™ voice outreach will appear here — so you can hear it before the call.</p>
              <div className="mt-4 h-px bg-ink/10" />
              <p className="text-muted-light text-xs mt-4">[Video embed — configure before launch]</p>
            </div>

            <Link href="/" className="text-sm text-muted hover:text-revive transition-colors underline underline-offset-2">
              ← Back to homepage
            </Link>
          </div>
        </div>
