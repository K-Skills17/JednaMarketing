...
export const metadata: Metadata = {
  title: "Jedna LLC — Performance-Only Patient Reactivation for Dental Practices",
  description:
  ...
  twitter: {
    ...
    title: "Jedna LLC — Performance-Only Patient Reactivation",
...
const orgSchema = {
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "4 Peddlers Row Unit 216",
